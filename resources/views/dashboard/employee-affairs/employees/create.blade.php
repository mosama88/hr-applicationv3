                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 ">
                                                    ...
                                                    <select
                                                        ...
                                                        name="graduation_estimate" aria-label="Default select example">
                                                        <option selected value="">-- أختر
                                                            تقدير
                                                            التخرج --
                                                        </option>
                                                ...
                                                <div class="col-md-3 ">
                                                    <label for="major-input" class="form-label">
                                                        تخصص التخرج</label>
                                                    <input type="text" id="major-input" value="{{ old('major') }}"
                                                ...
                                                <div class="col-md-4" id="license_type_container" style="display: none;">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="has_disabilities" class="form-label">هل
                                                        يمتلك
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" id="notes-input" value="{{ old('notes') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="military_status" class="form-label">حالة
                                            الخدمة
                                            العسكرية</label>
                                        <select class="form-select @error('military') is-invalid @enderror"
                                            id="military_status" name="military" aria-label="Default select example">
                                            <option selected value="">-- أختر
                                                الحالة --
                                            </option>
                                    ...
                                    <div id="exemption_temporary_fields" style="display: none;">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="military_postponement_reason">سبب
                                                ومدة تأجيل
                                            ...
                                            <input type="text" id="military_postponement_reason"
                                                ...
                                                name="military_postponement_reason" placeholder="أذكر السبب والمدة" />
                                    ...
                                    <div id="final_exemption_fields" style="display: none;">
                                        <!-- تاريخ اعفاء الخدمة العسكرية -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="military_exemption_date_final">تاريخ
                                                اعفاء
                                                الخدمة
                                                العسكرية</label>
                                            <input type="text" name="military_exemption_date"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="military_exemption_reason"
                                                ...
                                                name="military_exemption_reason" placeholder="أذكر السبب" />
                                    ...
                                    <div id="complete_service_fields" style="display: none;">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="military_service_start_date">تاريخ
                                                بداية
                                                الخدمة
                                                العسكرية</label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="military_service_end_date">تاريخ
                                                نهاية الخدمة
                                                العسكرية</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label" for="department_id-input">الادارة
                                            التابع لها الموظف</label>
                                        <select class="select2 form-select @error('department_id') is-invalid @enderror"
                                            name="department_id" data-allow-clear="true" id="department_id-input">
                                            <option selected value="">-- أختر
                                                الادارة --
                                            </option>
                                    ...
                                    <div class="col-md-3">
                                        <label for="has_fixed_shift" class="form-label">هل شفت
                                            ثابت</label>
                                        <select class="form-select @error('has_fixed_shift') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6" id="shifts_type_container" style="display: none;">
                                        <label for="shifts_type_id" class="form-label">أنواع
                                            الشفتات</label>
                                        <select class="form-select @error('shifts_type_id') is-invalid @enderror"
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <input type="text" id="daily_work_hour-input"
                                            ...
                                            name="daily_work_hour" oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                            placeholder="مثال:8" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="monthly_salary" value="{{ old('salary') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="daily_salary" value="{{ old('day_price') }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="has_social_insurance"
                                            ...
                                            name="has_social_insurance" aria-label="Default select example">
                                            <option selected value="">-- أختر
                                                الحالة --
                                            </option>
                                    ...
                                    <div class="col-md-5" style="display: none;" id="social_insurance_fields">
                                        <label class="form-label" for="social_insurance_cut_monthely-input">
                                            قيمة التأمين الاجتماعي المستقطع شهرياً
                                        </label>
                                    ...
                                    <div class="col-md-4" style="display: none;" id="social_insurance_value">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="has_medical_insurance"
                                            ...
                                            name="has_medical_insurance" aria-label="Default select example">
                                            <option selected value="">-- أختر
                                                الحالة --
                                            </option>
                                    ...
                                    <div class="col-md-5" style="display: none;" id="medical_insurance_fields">
                                        <label class="form-label" for="has_social_insurance">
                                            قيمة التأمين الطبي المستقطع شهرياً
                                        </label>
                                    ...
                                    <div class="col-md-4" style="display: none;" id="medical_insurance_value">
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <select class="form-select @error('type_salary_receipt') is-invalid @enderror"
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <select class="form-select @error('has_fixed_allowances') is-invalid @enderror"
                                    ...
                                    <div class="col-md-3 ">
                                        <label class="form-label" for="motivation_type">
                                            هل له حافز</label>
                                        <select class="form-select @error('motivation_type') is-invalid @enderror"
                                    ...
                                    <div class="col-md-3" style="display: none;" id="fixed_motivation_value">
                                        <label class="form-label" for="motivation_value">
                                            قيمة الحافز الشهري الثابت </label>
                                        <input type="text" id="" value="{{ old('motivation_value') }}"
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <select class="form-select @error('has_vacation_balance') is-invalid @enderror"
                            ...
                            <div class="tab-pane fade" id="additional" role="tabpanel">
                                <div class="row g-3  mt-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="" value="{{ old('pasport_identity') }}"
