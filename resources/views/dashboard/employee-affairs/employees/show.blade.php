...
@section('title', 'عرض بيانات الموظف جديد')
@push('css')
...
@section('content')
    ...
    @include('dashboard.layouts.breadcrumbs', [
        'titlePage' => 'عرض بيانات الموظف جديد',
        'previousPage' => 'الموظفين',
        'currentPage' => 'عرض بيانات الموظف جديد',
        'url' => 'employees.index',
    ])
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="military_exemption_date" placeholder="يوم / شهر / سنة"
