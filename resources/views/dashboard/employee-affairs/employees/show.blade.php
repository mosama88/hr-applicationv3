                    ...
                    <div class="card card-dark card-outline mb-4">
                        ...
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="employee-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="upload-tab" data-toggle="pill" href="#upload" role="tab">
                                        <i class="fa-solid fa-upload mx-1"></i>ارفاق مستندات
                                    </a>
                                </li>
                            </ul>
                            <div class="col-md-12">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-4 ">
                                                    <label class="form-label" for="mobile-input">
                                                        هاتف المحمول</label>
                                                    <input type="text" value="{{ old('mobile', $employee->mobile) }}"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-4 mb-3 related_miltary_postponement">
                                                        <label class="form-label" for="military_postponement_date">تاريخ
                                        ...
                                        <div class="tab-pane fade" id="upload" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        @forelse ($employeeFiles as $employeeFile)
                                                            <tr>
