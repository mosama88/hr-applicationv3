...
@section('title', 'السجلات الرئيسية للسلف الشهرية')
@push('css')
@endpush
@section('content')
    ...
    @include('dashboard.layouts.breadcrumbs', [
        'titlePage' => 'السجلات الرئيسية للسلف الشهرية',
        'previousPage' => '',
        'class' => 'fa-solid fa-house',
        'currentPage' => 'السجلات الرئيسية للسلف الشهرية',
        'url' => 'index',
    ])
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">السجلات الرئيسية للسلف الشهرية </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                        ...
                                        <tr data-widget="expandable-table" aria-expanded="false">
                                            ...
                                            <td>
                                                @if ($financeClnPeriod->is_open == FinanceClnPeriodsIsOpen::Archived)
                                                    ...
                                                    <a title="عرض"
                                                        href="{{ route('dashboard.loans.show', $financeClnPeriod->slug) }}"
