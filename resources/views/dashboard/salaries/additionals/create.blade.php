...
@section('title', 'انشاء أضافى للموظف')
@push('css')
...
@section('content')
    ...
    @include('dashboard.layouts.breadcrumbs', [
        'titlePage' => 'انشاء أضافى للموظف ',
        'previousPage' => 'جدول الأضافى',
        'currentPage' => 'انشاء أضافى للموظف ',
        'url' => 'additionals.show',
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <form action="{{ route('dashboard.additionals.store', $financeClnPeriod->id) }}" method="POST"
                            id="storeForm">
                            @csrf
                            <div class="card-body">
                                <div class="row">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // حساب القيمة الإجمالية للأضافى عند تغيير عدد الأيام
