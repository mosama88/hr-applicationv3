...
@section('title', 'تعديل الاضافى الموظف')
@push('css')
...
@section('content')
    ...
    @include('dashboard.layouts.breadcrumbs', [
        'titlePage' => 'تعديل الاضافى  للموظف ',
        'previousPage' => 'جدول الاضافى ات',
        'currentPage' => 'تعديل الاضافى  للموظف ',
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-info card-outline mb-4">
                        ...
                        <form action="{{ route('dashboard.additionals.update', $additional->slug) }}" method="POST"
                            id="storeForm">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-md-3" style="display: none">
                                        ...
                                        <input readonly type="text" name="finance_cln_period_id"
                                            ...
                                            value="{{ old('finance_cln_period_id', $additional->finance_cln_period_id) }}"
                                            id="exampleInputname">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="main_salary_employee_id" id="main_salary_employee_id-input"
                                            ...
                                            <option
                                                value="{{ old('main_salary_employee_id', $additional->main_salary_employee_id ?? '') }}"
                                                selected>
                                                {{ MainSalaryEmployee::find(old('main_salary_employee_id', $additional->main_salary_employee_id))->employee_name }}
                                            </option>
                                        </select>
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // حساب القيمة الإجمالية للالاضافى  عند تغيير عدد الأيام
