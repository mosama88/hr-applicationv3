...
@section('content')
    ...
    @include('dashboard.layouts.breadcrumbs', [
        'titlePage' => 'جدول أضافى الموظفين',
        'previousPage' => 'سجل الشهور المالية للأضافى',
        'currentPage' => 'جدول أضافى الموظفين',
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @include('dashboard.salaries.additionals.partials.filter')
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <!-- النص على اليمين -->
                                    <a href="{{ route('dashboard.additionals.create', $financeClnPeriod->slug) }}"
                            ...
                            <div class="card-tools">
                                <h4 class="mb-0">جدول أضافى الموظفين</h4>
                            </div>
                        </div>
