...
@section('title', 'السجلات الرئيسية للمكافأت')
@push('css')
@endpush
@section('content')
    ...
    @include('dashboard.layouts.breadcrumbs', [
        'titlePage' => 'السجلات الرئيسية للمكافأت',
        'previousPage' => '',
        'class' => 'fa-solid fa-house',
        'currentPage' => 'السجلات الرئيسية للمكافأت',
        'url' => 'index',
    ])
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">السجلات الرئيسية للمكافأت </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                        ...
                                        <tr data-widget="expandable-table" aria-expanded="false">
                                            ...
                                            <td>
                                                @if ($financeClnPeriod->is_open == FinanceClnPeriodsIsOpen::Archived)
                                                    ...
                                                    <a title="عرض"
                                                        href="{{ route('dashboard.rewards.show', $financeClnPeriod->slug) }}"
