            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <!--end::Header-->
                        <!--begin::Form-->
                        <form action="{{ route('dashboard.admins.update', $branch->slug) }}" method="POST" id="updateForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="exampleFormControlSelect1" class="form-label">حالة المستخدم</label>
