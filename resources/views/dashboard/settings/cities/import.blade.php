    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">إستيراد ملف المدن</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('dashboard.cities.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="alert alert-info" style="direction: rtl; text-align: right;">
                        ...
                        <ul>
                            ...
                            <li>✅ تأكد من أن الأعمدة مرتبة كما يلي: الاسم، المحافظة.</li>
