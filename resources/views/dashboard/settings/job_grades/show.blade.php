                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input disabled type="text"
                                            value="{{ optional($jobGrade->createdBy)->name }} {{ $jobGrade->created_at ? '(' . $jobGrade->created_at->format('Y-m-d H:i') . ')' : '' }}"
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input disabled type="text"
                                            value="{{ $jobGrade->updated_by ? $jobGrade->updatedBy->name : '' }}{{ ' ' }}({{ optional($jobGrade->updated_at)->format('Y-m-d H:i') }})"
                                            name="decision_number" class="form-control bg-white"
                                            id="exampleInputdecision_number">
                                    </div>
                                </div>
