...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('main_salary_employees', function (Blueprint $table) {
            ...
            $table->enum('cash_visa', ['Cach', 'Visa'])->nullable()->default('Cach'); //قبض المرتب كاش ام فيزا
            $table->enum('is_sensitive_manager_data', ['yes', 'no'])->nullable()->default('yes'); //هل الموظف بإدارة عليا بها بيانات حساسة
            $table->enum('is_stopped', ['stopped', 'unstopped'])->nullable()->default('unstopped'); //المرتب موقوف ام سارى
