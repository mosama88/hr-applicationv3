...
class AllowanceExport implements FromArray, WithHeadings, WithStyles
{
    protected $data;
    ...
    public function __construct($allowances)
    {
        ...
        $this->data = $allowances->map(function ($allowance) {
            return [
                'name'   => $allowance->name,
            ];
        })->toArray();
    ...
    {
        return ['نوع البدل']; // ترجم العناوين حسب الأعمدة المختارة
    }
