...
class DiscountTypeExport implements FromArray, WithHeadings, WithStyles
{
    protected $data;

    public function __construct($discount_types)
    {
        // نحضّر فقط الأعمدة المطلوبة
        $this->data = $discount_types->map(function ($discount_type) {
            return [
    ...
    {
        return ['نوع الخصم']; // ترجم العناوين حسب الأعمدة المختارة
    }
