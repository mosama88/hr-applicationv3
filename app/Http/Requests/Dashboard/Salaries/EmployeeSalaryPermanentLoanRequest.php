...
class EmployeeSalaryPermanentLoanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'month_number_installment' => 'nullable|integer|min:1',
            'month_installment_value' => 'nullable|min:0',
            'year_month_start' => 'nullable|string|max:20',
            'year_month_start_date' => 'nullable|date',
            ...
            'active' => [
                'required',
                Rule::in(array_column(IsArchivedEnum::cases(), 'value')),
            ],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'active.in' => 'حالة التفعيل يجب أن تكون 0 (غير مفعل) أو 1 (مفعل).',
        ];
    }
}