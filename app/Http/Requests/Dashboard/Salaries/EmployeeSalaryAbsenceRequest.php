...
class EmployeeSalaryAbsenceRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'sanctions_type.required' => 'يجب اختيار نوع الغياب.',
            'sanctions_type.in' => 'نوع الغياب غير صالح.',

            'value.required' => 'يجب إدخال قيمة الغياب.',
